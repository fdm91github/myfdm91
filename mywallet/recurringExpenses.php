    ...
    <div class="container mt-5">
		<div class="card mb-4">
			<div class="card-header d-flex justify-content-between align-items-center flex-wrap">
				...
				<button class="btn btn-primary btn-custom" data-toggle="modal" data-target="#addRecurringExpenseModal">
								...
								<tr>
									...
									<td>
										<button class="btn btn-warning btn-sm" 
												data-toggle="modal" 
												data-target="#editRecurringExpenseModal" 
										...
										<button class="btn btn-danger btn-sm" 
												data-toggle="modal" 
												data-target="#deleteRecurringExpenseModal" 
												data-id="<?php echo $expense['id']; ?>">
